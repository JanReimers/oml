// File: UT-Vector-complex.cc  Unit test the Vector class for complex data types.
...
int main()
{
  const char* Class="Vector<std::complex<T> >";
  bool pass=true;
//
//  Start message.
//
  ...
  Vector<std::complex<double> > A(-1,10),B(-1,10);
...
//	
  ...
  {
    Vector<std::complex<double> > A(1000),B;
